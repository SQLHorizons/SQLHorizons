...
#######################  apply:  audit_cntl_8.4d audit  #######################

$Audit = $step = "database.privileged.user.access.log"
$SQLsrv.Refresh()
...
if(!($SQLsrv.Audits.Item($Audit))){  
    ...
    ## Set audit events.
    $events  = "AuditChangeGroup","ApplicationRoleChangePasswordGroup"
	$events += "DatabaseChangeGroup","DatabaseObjectOwnershipChangeGroup"
	$events += "DatabaseObjectPermissionChangeGroup","DatabaseOwnershipChangeGroup"
	$events += "DatabasePermissionChangeGroup","DatabasePrincipalChangeGroup"
	$events += "DatabaseRoleMemberChangeGroup","SchemaObjectAccessGroup"
	$events += "SchemaObjectOwnershipChangeGroup","SchemaObjectPermissionChangeGroup"
	$events += "UserChangePasswordGroup"
